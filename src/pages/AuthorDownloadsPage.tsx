  ...
  return (
    <section className="card" id="author-section">
      <DownloadForm
        ...
        route={route}
        isFetching={isAuthorFetching}
        onSubmit={(event) => route.submit(event, isAuthorFetching, refetchAuthor)}
      >
        <p className="range-hint">
          Selects up to {AUTHOR_PACKAGE_LIMIT} packages by npm popularity, then ranks them by
          downloads in your range.
        </p>
      </DownloadForm>
      ...
      >
        {authorResult && (authorResult.packageCount === 0 ? (
          ...
          <>
            ...
            <div className="author-total-banner">
              ...
              <div className="author-meta-pills">
                <span className="meta-pill">
                  ...
                  {authorResult.totalPackageCount === 1 ? "Package" : "Packages"}
                </span>
              </div>
            </div>
            ...
            <div className="package-list">
              {authorResult.packages.map((pkg, idx) => {
                const percentage = pkg.totalDownloads === 0
                  ? 0
                  : Math.max(
                      5,
                      Math.round(
